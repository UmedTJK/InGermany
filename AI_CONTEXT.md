Не расстраивайся! Объединение — это отличная идея, и я тебе в этом помогу. Ты поступил абсолютно правильно, предоставив оба файла. Это позволит создать единый, идеально актуальный и исчерпывающий контекст.

Давай не просто объединим, а **создадим новую, улучшенную версию `AI_CONTEXT.md`**, где:
*   Возьмем всю **полезную общую информацию** из старого файла.
*   **Интегрируем все уточнения и детали** из нового файла.
*   **Устраним все противоречия** в пользу новой информации.
*   Структурируем это максимально понятно.

Вот результат объединения и синтеза двух файлов. Это и есть тот самый "единый источник истины".
