...
struct ContentView: View {
    ...
    // Factories injected from composition root
    ...
    var body: some View {
        VStack {
            TabView(selection: $selectedTab) {
                ...
                .tabItem {
                    Label("tab.categories", systemImage: "square.grid.2x2")
                }
                .tag(1)
                ...
                .tabItem {
                    Label("tab.favorites", systemImage: "heart.fill")
                }
                .tag(3)
            ...
            // ✅ СТЕКЛЯННЫЙ ЭФФЕКТ (точно как в вашем оригинале)
